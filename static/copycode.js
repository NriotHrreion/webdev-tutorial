...
(function() {
    ...
    function docsifyCopyCode(hook, vm) {
        hook.doneEach(function() {
            ...
            var template = [ '<button class="docsify-copy-code-button">',
            ...
            listenerHost.addEventListener("click", function(evt) {
                ...
                if (isCopyCodeButton) {
                    ...
                    try {
                        ...
                        if(successful) {
                            buttonElm.getElementsByClassName("label")[0].innerHTML = window.$docsify.copyCode.successText == undefined ? "Copied" : window.$docsify.copyCode.successText;
                            setTimeout(function() {
                                buttonElm.style.opacity = "0";
                                setTimeout(function() {
                                    buttonElm.getElementsByClassName("label")[0].innerHTML = window.$docsify.copyCode.buttonText == undefined ? "Copy to clipboard" : window.$docsify.copyCode.buttonText;
                                }, 100);
                            }, 1e3);
                        }
                    } catch (err) {
